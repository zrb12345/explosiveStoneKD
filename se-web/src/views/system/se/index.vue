...
-->
      <el-col :span="24" :xs="24">
        <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch"
          ...
          <!-- <el-form-item label="平均块度" prop="zyl">
            <el-input v-model="queryParams.zyl" placeholder="请输入平均块度" clearable style="width: 240px"
              @keyup.enter.native="handleQuery" />
          </el-form-item> -->
          ...
          <el-form-item label="孔数" prop="ks">
            <el-input v-model="queryParams.ks" placeholder="请输入大块率" clearable style="width: 240px"
              @keyup.enter.native="handleQuery" />
          </el-form-item>
        ...
        <el-table v-loading="loading" :data="seList" @selection-change="handleSelectionChange"
          ...
          <el-table-column label="强度" align="center" key="qd" prop="qd" v-if="columns[2].visible"
            :show-overflow-tooltip="true" />
          <el-table-column label="装药量" align="center" key="zyl" prop="zyl" v-if="columns[3].visible" />
          ...
          <el-table-column label="孔数" align="center" key="ks" prop="ks" v-if="columns[6].visible" />/
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="装药量" prop="zyl">
              <el-input v-model="form.zyl" placeholder="请输入块度" maxlength="30" />
            </el-form-item>
          </el-col>
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="泊松比" prop="ks">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="孔数" prop="ks">
              <el-input v-model="form.ks" placeholder="请输入大块率" maxlength="30" />
            </el-form-item>
          </el-col>
...
export default {
  ...
  methods: {
    ...
    handleStatusChange(row) {
      ...
      this.$modal.confirm('确认要"' + text + '""' + row.zyl + '"数据吗？').then(function () {
